...
from anypod.db.types import timezone_aware_datetime
from anypod.db.types import feed
...
def upgrade() -> None:
    ...
    sa.Column('source_url', AutoString(), nullable=False),
    sa.Column('last_successful_sync', timezone_aware_datetime.TimezoneAwareDatetime(), server_default=sa.text("(datetime('now', 'utc'))"), nullable=False),
    sa.Column('created_at', timezone_aware_datetime.TimezoneAwareDatetime(), server_default=sa.text("(datetime('now', 'utc'))"), nullable=False),
    sa.Column('updated_at', timezone_aware_datetime.TimezoneAwareDatetime(), server_default=sa.text("(datetime('now', 'utc'))"), nullable=False),
    sa.Column('last_rss_generation', timezone_aware_datetime.TimezoneAwareDatetime(), nullable=True),
    sa.Column('last_failed_sync', timezone_aware_datetime.TimezoneAwareDatetime(), nullable=True),
    sa.Column('consecutive_failures', sa.Integer(), server_default='0', nullable=False),
    sa.Column('total_downloads', sa.Integer(), server_default='0', nullable=False),
    sa.Column('since', timezone_aware_datetime.TimezoneAwareDatetime(), nullable=True),
    sa.Column('keep_last', sa.Integer(), nullable=True),
    sa.Column('title', AutoString(), nullable=True),
    sa.Column('subtitle', AutoString(), nullable=True),
    sa.Column('description', AutoString(), nullable=True),
    sa.Column('language', AutoString(), nullable=True),
    sa.Column('author', AutoString(), nullable=True),
    sa.Column('image_url', AutoString(), nullable=True),
    sa.Column('category', feed.PodcastCategoriesType(), server_default='TV & Film', nullable=False),
    ...
    sa.Column('feed_id', AutoString(), nullable=False),
    sa.Column('id', AutoString(), nullable=False),
    sa.Column('source_url', AutoString(), nullable=False),
    sa.Column('title', AutoString(), nullable=False),
    sa.Column('published', timezone_aware_datetime.TimezoneAwareDatetime(), nullable=False),
    sa.Column('ext', AutoString(), nullable=False),
    ...
    sa.Column('discovered_at', timezone_aware_datetime.TimezoneAwareDatetime(), server_default=sa.text("(datetime('now', 'utc'))"), nullable=False),
    sa.Column('updated_at', timezone_aware_datetime.TimezoneAwareDatetime(), server_default=sa.text("(datetime('now', 'utc'))"), nullable=False),
    sa.Column('thumbnail', AutoString(), nullable=True),
    sa.Column('description', AutoString(), nullable=True),
    sa.Column('quality_info', AutoString(), nullable=True),
    sa.Column('retries', sa.Integer(), server_default='0', nullable=False),
    sa.Column('last_error', AutoString(), nullable=True),
    sa.Column('downloaded_at', timezone_aware_datetime.TimezoneAwareDatetime(), nullable=True),
