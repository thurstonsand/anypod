...
def test_refresh_metadata_success(
    ...
    mock_data_coordinator.refresh_download_metadata.return_value = updated_download
...
def test_refresh_metadata_no_changes(
    ...
    mock_data_coordinator.refresh_download_metadata.return_value = sample_download
